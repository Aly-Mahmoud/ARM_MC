...
#define GPIO_PORT_A						    ((GPIOx_Peri_t* )(GPIOA_u32BASEADDRESS))

#define GPIOB_u32BASEADDRESS 		         0x4002 0400
#define GPIO_PORT_B						    ((GPIOx_Peri_t* )(GPIOB_u32BASEADDRESS))

#define GPIOC_u32BASEADDRESS 		        0x4002 0800
#define GPIO_PORT_C						    ((GPIOx_Peri_t* )(GPIOC_u32BASEADDRESS))
...
/*API*/
    ...
    /*Init Function*/
	    GPIO_Error_t GPIO_Init(GPIO_Pin_t *GPIO_pincfg)
        {
            ...
            /*error handling*/
                if (GPIO_pincfg->Port == NULL)
                {
                    LOC_Status = GPIO_NULL_POINER;
                }

                else if(GPIO_pincfg->MODE & GPIO_MODE_Verfier == NO_MATCH)
                {
                    LOC_Status = GPIO_INVALID_MODE;
                }

                else if(GPIO_pincfg->Speed & GPIO_SPEED_Verfire == NO_MATCH)
                {
                    LOC_Status = GPIO_INVALID_MODE;
                }
            /*-------------*/
    ...
    /*Set Pin value*/
        GPIO_Error_t GPIO_Set_PinValue(void *GPIO_Port_x, U32 GPIO_Pin_x , U32 GPIO_STATE_x)
        {
            ...
            /*Error Handling*/
                ...
                else if ( GPIO_STATE_RESET < GPIO_MODE || GPIO_MODE > GPIO_STATE_SET )
                {
            ...
            /*Function*/
                else 
                {
                    ...
                    case GPIO_STATE_RESET :
                        ((GPIOx_Peri_t *)GPIO_Port)->BSRR = 1 << GPIO_Pin;
                    break;

                    case GPIO_STATE_SET :
                        ((GPIOx_Peri_t *)GPIO_Port)->BSRR = 1 << ( GPIO_Pin + HALF_WORD_OFFSET );
                    break;
        ...
        GPIO_Error_t GPIO_Get_PinValue(void *GPIO_Port_x, U32 GPIO_Pin_x, U8 *GPIO_Pin_State)
        {
            ...
            /*Function*/
                ...
                else
                {
                    ...
                    *GPIO_Pin_State = (((GPIOx_Peri_t *)GPIO_Port_x)->IDR >> GPIO_Pin_x) & BIT00_MASK;
                }
        ...
        GPIO_Error_t GPIO_CFG_AlternateFunction(void *GPIO_Port_x, U32 GPIO_Pin_x, U32 GPIO_FUNC_AFx)
        {
            ...
            /*Function*/
                else
                {
                    ...
                    {
                        /*Reciece the value of MODE in Local variable*/
                            LOC_AFR_Value = (((GPIOx_Peri_t *)GPIO_Port_x)->AFRH);
                        /*-------------------------------------------*/
                        ...
                        /*Send the configuration to the register*/
                            (((GPIOx_Peri_t *)GPIO_Port_x)->AFRH) = LOC_AFR_Value;
                        /*-------------------------------------------*/
                    }
                    ...
                    {
                        /*Reciece the value of MODE in Local variable*/
                            LOC_AFR_Value = (((GPIOx_Peri_t *)GPIO_Port_x)->AFRL);
                        /*-------------------------------------------*/
                        ...
                        /*Send the configuration to the register*/
                            (((GPIOx_Peri_t *)GPIO_Port_x)->AFRL) = LOC_AFR_Value;
                        /*-------------------------------------------*/
                    }
                }
